	...
	return (
		<div
			className={classNames(
				"after:content-[''] after:absolute after:top-0 after:left-0 after:-z-30 after:opacity-50 after:animate-delay-[15s] before:content-[''] before:absolute before:top-0 before:left-0 before:-z-30 before:opacity-50",
				top
