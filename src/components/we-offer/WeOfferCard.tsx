...
export const CourseCard = ({
	...
	const CourseCardClasses = classNames(
		'flex justify-center sq:justify-normal items-center border border-[#8051F8] py-[35px] px-[30px] rounded-[15px] max-w-[501px] min-w-full md:min-w-[300px] lg:min-w-[300px] hover:bg-[#3D3570] transition active:bg-opacity-0 gap-x-[10px]',
		className || ''
	)
